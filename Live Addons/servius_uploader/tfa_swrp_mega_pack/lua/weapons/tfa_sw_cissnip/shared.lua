...
SWEP.IronSightsPos = Vector(-6.665, -18, 2.391)
...
SWEP.TracerName 		= "effect_sw_laser_red" 	--Change to a string of your tracer name.  Can be custom.						--There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.scout_Parent", rel = "", pos = Vector(0.035, -5.785, -10.783), angle = Angle(90, 180, 90), size = Vector(0.163, 0.163, 0.163), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["element_name"] = { type = "Model", model = "models/swbf3/cis/sniperrifle.mdl", bone = "v_weapon.scout_Parent", rel = "", pos = Vector(0, 1.325, -11.08), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
