...
if ( CLIENT ) then
	SWEP.PrintName			= "Imperial Disruptor"			
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/swbf3/imp/sniperrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.026, 1, -0.519), angle = Angle(-164.805, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
