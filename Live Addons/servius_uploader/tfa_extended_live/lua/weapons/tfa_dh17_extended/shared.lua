...
SWEP.IronSightsPos = Vector(-4.22, -2, 1.759)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0.019, 4.4, 4.59), angle = Angle(0, -90, 0), size = Vector(0.308, 0.308, 0.308), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
