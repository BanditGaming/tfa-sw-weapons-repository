...
SWEP.Primary.Sound = Sound ("weapons/x8/x8_fire_1.ogg");
...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.awm_parent", rel = "element_name", pos = Vector(-0.76, 3, 6.8), angle = Angle(0, -90, 0), size = Vector(0.38, 0.38, 0.38), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
