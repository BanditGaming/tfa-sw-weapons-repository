...
SWEP.Category				= "TFA Heavy Weaponss" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/servius/starwars/cwa/flamethrower_variant.mdl", bone = "minigun", rel = "", pos = Vector(1.1, 7.4, -7.301), angle = Angle(0, 90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/servius/starwars/cwa/flamethrower_variant.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.4, 0.5, -0.201), angle = Angle(-90, 0, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
