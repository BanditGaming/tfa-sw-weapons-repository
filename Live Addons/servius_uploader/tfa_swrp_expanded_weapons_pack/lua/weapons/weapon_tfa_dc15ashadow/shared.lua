...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A Shadow Edition"			
	...
	killicon.Add( "weapon_tfa_dc15ashadow", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_SHD5A.mdl"
SWEP.WorldModel				= "models/weapons/w_SHD5A.mdl"
