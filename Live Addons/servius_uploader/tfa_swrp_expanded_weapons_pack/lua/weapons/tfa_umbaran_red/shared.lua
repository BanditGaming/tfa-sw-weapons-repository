...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/servius/starwars/cwa2/umbaran_red_rifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.901, 0.899, 1), angle = Angle(-106, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/servius/starwars/cwa2/umbaran_red_rifle.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-0.301, -1, 7), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
