...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15 Side Arm Talon Edition"			
	...
	killicon.Add( "weapon_tfa_dc15satalon", "HUD/killicons/DC15SA", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_tal5SA.mdl"
SWEP.WorldModel				= "models/weapons/w_tal5SA.mdl"
