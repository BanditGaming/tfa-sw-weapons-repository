...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A Talon Edition"			
	...
	killicon.Add( "weapon_tfa_dc15atalon", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_tal5A.mdl"
SWEP.WorldModel				= "models/weapons/w_tal5A.mdl"
