...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A EOD Edition"			
	...
	killicon.Add( "weapon_tfa_dc15aeod", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_EOD5A.mdl"
SWEP.WorldModel				= "models/weapons/w_EOD5A.mdl"
