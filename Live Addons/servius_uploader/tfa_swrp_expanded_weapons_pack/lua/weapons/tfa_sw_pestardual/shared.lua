...
if ( CLIENT ) then
	SWEP.PrintName			= "Dual Gold Westar"			
	SWEP.Author				= "Servius"
	SWEP.ViewModelFOV      	= 76
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon = surface.GetTextureID("HUD/killicons/WESTAR34")
	killicon.Add( "tfa_sw_pestardual", "HUD/killicons/WESTAR34", Color( 255, 80, 0, 255 ) )
end
...
SWEP.VElements = {
	["pestar"] = { type = "Model", model = "models/weapons/w_pestar34.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(-0.519, -1.558, 4.675), angle = Angle(90, -99.351, 15.194), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["pestar+"] = { type = "Model", model = "models/weapons/w_pestar34.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(-0.519, -1.558, 4.675), angle = Angle(90, -99.351, 15.194), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
