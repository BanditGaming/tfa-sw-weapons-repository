...
SWEP.Primary.Sound = Sound("weapons/dc17_negotiator/WPN_DC17_NEGOTIATOR_SHOOT.ogg")
...
SWEP.IronSightsPos = Vector(-4.4, 5, 2)
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/dc17chrome/dc17chrome.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(.15, 0, -1), angle = Angle(0, -90, 0), size = Vector(1.144, 1.144, 1.144), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
