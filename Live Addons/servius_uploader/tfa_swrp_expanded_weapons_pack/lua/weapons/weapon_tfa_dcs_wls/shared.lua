...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15S Woodland DPM"			
	...
	killicon.Add( "weapon_tfa_dcs_wls", "HUD/killicons/DC15S", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_DCwlS.mdl"
SWEP.WorldModel				= "models/weapons/w_DCwlS.mdl"
