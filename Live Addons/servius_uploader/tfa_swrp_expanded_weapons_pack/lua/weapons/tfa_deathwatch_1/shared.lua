...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/servius/starwars/cwa/carlac_deathwatchrifle.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0.518, 0.518, -0.519), angle = Angle(87.662, -85.325, -1.17), size = Vector(1.144, 1.144, 1.144), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
