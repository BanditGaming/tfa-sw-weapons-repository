...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A Woodland DPM"			
	...
	killicon.Add( "weapon_tfa_dc15a_wla", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_DCwlA.mdl"
SWEP.WorldModel				= "models/weapons/w_DCwlA.mdl"
