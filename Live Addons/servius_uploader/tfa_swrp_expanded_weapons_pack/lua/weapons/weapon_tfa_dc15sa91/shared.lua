...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15 Side Arm 91st Edition"			
	...
	killicon.Add( "weapon_tfa_dc15sa91", "HUD/killicons/DC15SA", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_0915SA.mdl"
SWEP.WorldModel				= "models/weapons/w_0915SA.mdl"
