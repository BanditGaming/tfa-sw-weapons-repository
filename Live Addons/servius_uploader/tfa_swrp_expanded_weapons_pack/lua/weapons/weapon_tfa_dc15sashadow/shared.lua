...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15 Side Arm Shadow Edition"			
	...
	killicon.Add( "weapon_tfa_dc15sashadow", "HUD/killicons/DC15SA", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_SHD5SA.mdl"
SWEP.WorldModel				= "models/weapons/w_SHD5SA.mdl"
