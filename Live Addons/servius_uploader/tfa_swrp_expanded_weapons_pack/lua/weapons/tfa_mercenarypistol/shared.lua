...
SWEP.Primary.Sound = Sound ("weapons/ll30/WPN_LL30_Shoot_2.ogg");
...
SWEP.IronSightsPos = Vector(-4.62, -0 , 2.5)
...
SWEP.VElements = {
	...
	["element_name"] = { type = "Model", model = "models/mercenarypistol/mercenarypistol.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0.4, 0.28, -1.5), angle = Angle(-0, -90, -0), size = Vector(1.144, 1.144, 1.144), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
