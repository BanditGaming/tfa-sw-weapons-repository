...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A Woodland Tiger"			
	...
	killicon.Add( "weapon_tfa_dc15a_wta", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_DCwtA.mdl"
SWEP.WorldModel				= "models/weapons/w_DCwtA.mdl"
