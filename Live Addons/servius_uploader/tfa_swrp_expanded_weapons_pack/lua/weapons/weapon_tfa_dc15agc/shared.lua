...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A Green Company Edition"			
	...
	killicon.Add( "weapon_tfa_dc15agc", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_GRC5A.mdl"
SWEP.WorldModel				= "models/weapons/w_GRC5A.mdl"
