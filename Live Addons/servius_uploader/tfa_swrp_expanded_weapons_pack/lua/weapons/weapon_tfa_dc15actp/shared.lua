...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A CTP Edition"			
	...
	killicon.Add( "weapon_tfa_dc15actp", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_CTP5A.mdl"
SWEP.WorldModel				= "models/weapons/w_CTP5A.mdl"
