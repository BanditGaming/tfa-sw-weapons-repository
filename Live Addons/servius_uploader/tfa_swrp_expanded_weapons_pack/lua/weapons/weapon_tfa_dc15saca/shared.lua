...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15 Side Arm Assassin Edition"			
	...
	killicon.Add( "weapon_tfa_dc15saca", "HUD/killicons/DC15SA", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_cla5SA.mdl"
SWEP.WorldModel				= "models/weapons/w_cla5SA.mdl"
