...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15 Side Arm EOD Edition"			
	...
	killicon.Add( "weapon_tfa_dc15saeod", "HUD/killicons/DC15SA", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_EOD5SA.mdl"
SWEP.WorldModel				= "models/weapons/w_EOD5SA.mdl"
