...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15 Side Arm Clone Guard Edition"			
	...
	killicon.Add( "weapon_tfa_dc15sacg", "HUD/killicons/DC15SA", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_clg5SA.mdl"
SWEP.WorldModel				= "models/weapons/w_clg5SA.mdl"
