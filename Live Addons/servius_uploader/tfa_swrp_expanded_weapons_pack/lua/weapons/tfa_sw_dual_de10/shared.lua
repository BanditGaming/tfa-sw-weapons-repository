...
SWEP.VElements = {
	["de10"] = { type = "Model", model = "models/weapons/w_DE10.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(-0.519, -1.558, 4.675), angle = Angle(90, -99.351, 15.194), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["de10+"] = { type = "Model", model = "models/weapons/w_DE10.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(-0.519, -1.558, 4.675), angle = Angle(90, -99.351, 15.194), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
SWEP.Primary.Sound 			= Sound("weapons/de10/de10_fire.ogg")				-- This is the sound of the weapon, when you shoot.
SWEP.Callback = {}
