...
if ( CLIENT ) then
	SWEP.PrintName			= "Aura Sing Pistol"			
...
SWEP.IronSightsPos = Vector(-5, 8, 1)
SWEP.IronSightsAng = Vector(0, -1, -0)
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/aurasingpistol/aurasingpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.557, 0), angle = Angle(15.194, 176.494, 180), size = Vector(1.21, 1.21, 1.21), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/aurasingpistol/aurasingpistol.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0.4, 0.28, -0.519), angle = Angle(-0, -87, -0), size = Vector(1.144, 1.144, 1.144), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/aurasingpistol/aurasingpistol.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0.4, 0.28, -0.519), angle = Angle(-1.17, -82.987, -1.17), size = Vector(1.144, 1.144, 1.144), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
--]]
