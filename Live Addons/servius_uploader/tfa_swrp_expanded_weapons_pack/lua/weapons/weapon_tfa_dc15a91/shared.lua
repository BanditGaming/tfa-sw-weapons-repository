...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A 91st Edition"			
	...
	killicon.Add( "weapon_tfa_dc15a91", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_0915A.mdl"
SWEP.WorldModel				= "models/weapons/w_0915A.mdl"
