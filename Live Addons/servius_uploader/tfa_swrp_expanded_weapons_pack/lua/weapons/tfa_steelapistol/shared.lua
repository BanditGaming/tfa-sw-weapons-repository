...
SWEP.IronSightsPos = Vector(-4.3, 2, 2)
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/steelapistol/steelapistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 0), angle = Angle(15.194, 178.83, 180), size = Vector(1.47, 1.47, 1.47), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Object001", rel = "element_name", pos = Vector(0.27, 0.05, 5.139), angle = Angle(0, 0, -1), size = Vector(0.237, 0.237, 0.237), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["element_name"] = { type = "Model", model = "models/steelapistol/steelapistol.mdl", bone = "v_dh17_reference001", rel = "", pos = Vector(0.3, 0.28, -1.3), angle = Angle(0, -90, 0), size = Vector(1.144, 1.144, 1.144), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
