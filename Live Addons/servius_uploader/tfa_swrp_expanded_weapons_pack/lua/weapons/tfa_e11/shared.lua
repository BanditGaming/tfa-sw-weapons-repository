...
--ViewModel
SWEP.IronSightsPos = Vector(-7.3, -0, 2.16)
...
SWEP.VElements = {
	...
	["element_name"] = { type = "Model", model = "models/weapons/w_e11.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.899, -4, -6), angle = Angle(-180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
