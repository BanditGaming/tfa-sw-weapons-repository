...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15 Side Arm CTP Edition"			
	...
	killicon.Add( "weapon_tfa_dc15sactp", "HUD/killicons/DC15SA", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_CTP5SA.mdl"
SWEP.WorldModel				= "models/weapons/w_CTP5SA.mdl"
