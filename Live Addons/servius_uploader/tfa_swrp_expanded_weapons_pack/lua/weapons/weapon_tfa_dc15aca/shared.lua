...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "DC-15A Assassin Edition"			
	...
	killicon.Add( "weapon_tfa_dc15aca", "HUD/killicons/DC15A", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_cla5A.mdl"
SWEP.WorldModel				= "models/weapons/w_cla5A.mdl"
