...
SWEP.VElements = {
	["dl44"] = { type = "Model", model = "models/weapons/w_DL44.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(-0.519, -1.558, 4.675), angle = Angle(90, -99.351, 15.194), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["dl44+"] = { type = "Model", model = "models/weapons/w_DL44.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(-0.519, -1.558, 4.675), angle = Angle(90, -99.351, 15.194), size = Vector(0.69, 0.69, 0.69), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["dl44"] = { type = "Model", model = "models/weapons/w_DL44.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(9.362, 1.738, 3.665), angle = Angle(0, 0, 0), size = Vector(0.827, 0.827, 0.827), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.Base					= "tfa_swsft_base_servius"
SWEP.Category				= "TFA Blaster Pistols"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.Primary.Sound 			= Sound("weapons/dl44/DL44_fire.ogg")				-- This is the sound of the weapon, when you shoot.
SWEP.Callback = {}
SWEP.Callback.ChooseProceduralReloadAnim = function(self)
	self:EmitSound("weapons/shared/standard_reload.ogg.wav")
end
