...
SWEP.IronSightsPos = Vector(-4.821, 2, 1.809)
...
SWEP.VElements = {
	["element_scope"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.awm_parent", rel = "element_gun", pos = Vector(12, 1.59, 4.199), angle = Angle(0, 0, 0), size = Vector(0.34, 0.34, 0.34), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["element_gun"] = { type = "Model", model = "models/w_blstrrfl_001.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-0.519, -2.597, -7.792), angle = Angle(90, 0, -90), size = Vector(0.95, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
